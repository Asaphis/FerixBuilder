  ...
  return (
    <>
      <div className="stat-strip">
        <StatCard iconClass="level3" icon="◎" value="12.4K" label="API Calls Today" />
        <StatCard iconClass="tasks" icon="✓" value="99.98%" label="Success Rate" />
        <StatCard iconClass="rank" icon="★" value="142 ms" label="Avg Latency" />
        <StatCard iconClass="profile" icon="♦" value="3" label="API Keys" footnote="Manage keys" />
      </div>
